...
python preprocess_data.py \
  --wandb_project "nyc-green-taxi-tip-amount-training" \
  --wandb_entity "nelsonlin0321" \
  --raw_data_path "./data/" \
  --dest_path ./output
...
```bash
project_name="nyc-green-taxi-tip-amount-training"
entity="nelsonlin0321"
python train.py \
  --wandb_project ${project_name} \
  --wandb_entity ${entity} \
  --data_artifact "${entity}/${project_name}/NYC-Taxi:v0"
```
